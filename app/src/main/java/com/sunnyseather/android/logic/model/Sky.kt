package com.sunnyseather.android.logic.model
...
private val sky = mapOf(
    ...
    "LIGHT_HAZE" to Sky("轻度雾霾", R.drawable.ic_light_haze, R.drawable.bg_snow),
    "MODERATE_HAZE" to Sky("中度雾霾", R.drawable.ic_moderate_haze, R.drawable.bg_snow),
    "HEAVY_HAZE" to Sky("重度雾霾", R.drawable.ic_heavy_haze, R.drawable.bg_snow),
    "FOG" to Sky("雾", R.drawable.ic_fog, R.drawable.bg_snow),
    "DUST" to Sky("浮尘", R.drawable.ic_fog, R.drawable.bg_snow),
    )
